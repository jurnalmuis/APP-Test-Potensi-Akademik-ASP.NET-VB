...
Partial Class Admin_ChangeTimeDurasi
    ...
    Protected Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        ...
        Try
            cn.Open()
            Dim sql As String = "UPDATE TB_Ket SET timedurasi='" & timeket.Text & "' WHERE id_ket='1' "
            Dim cmd As SqlCommand = New SqlCommand(sql, cn)
            Dim jmlrec As Integer = cmd.ExecuteNonQuery
            If jmlrec > 0 Then
                pesan.InnerHtml = "Update Durasi Berhasil!"
                Response.AddHeader("REFRESH", "2;URL=LihatSoal.aspx")
            Else
                pesan.InnerHtml = "Update Durasi Gagal!!!!!!!!!!!!!"
            End If
