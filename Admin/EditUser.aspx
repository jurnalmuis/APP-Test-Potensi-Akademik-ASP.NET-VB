<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/MPAdmin.master" AutoEventWireup="false" CodeFile="EditUser.aspx.vb" Inherits="Admin_EditUser" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="py-4 table-bordered rounded">
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-4">
                    <asp:TextBox ID="NamaUsr" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-sm-2 text-right">Status User</div>
                <div class="col-sm-4">
