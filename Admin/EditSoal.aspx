<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/MPAdmin.master" AutoEventWireup="false" CodeFile="EditSoal.aspx.vb" Inherits="Admin_EditSoal" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container-fluid">
        <div class="row justify-content-center" style="margin-top:20px;"><h3>Edit Soal</h3></div>
        <div class="row justify-content-center text-danger" runat="server" id="pesan"></div>
    </div>
    <div class="py-4 table-bordered rounded">
            <div class="row mb-2">
                <div class="col-sm-2 text-right">ID Soal</div>
                <div class="col-sm-1">
            ...
            <div class="row mt-2">
                <div class="col-sm-2 text-right">Status Soal</div>
                <div class="col-sm-4">
                    <asp:DropDownList ID="stSoal" runat="server" CssClass="form-control text-primary">
                        <asp:ListItem>Status Soal</asp:ListItem>
