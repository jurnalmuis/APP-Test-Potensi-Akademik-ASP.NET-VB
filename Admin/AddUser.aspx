<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/MPAdmin.master" AutoEventWireup="false" CodeFile="AddUser.aspx.vb" Inherits="Admin_AddUser" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container-fluid">
        <div class="row justify-content-center" style="margin-top:20px;"><h3>Tambah User</h3></div>
    ...
    <div class="py-4 table-bordered rounded">
            <div class="row mb-2">
                ...
                <div class="col-sm-3">
                    <asp:TextBox ID="nomor" CssClass="form-control" runat="server" MaxLength="10"></asp:TextBox>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-sm-2 text-right">Nama User</div>
                <div class="col-sm-3">
