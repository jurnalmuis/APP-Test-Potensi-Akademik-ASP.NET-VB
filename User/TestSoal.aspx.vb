        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                If benar = 1 Then
                    Response.Redirect("LihatHasil.aspx")
                Else
                    Dim sqlsoal As String = "SELECT id_soal,soal,a,b,c,d FROM TB_Tes WHERE id_soal='" & nomor.Text & "' AND status='Aktif' "
                    Dim cmdsoal As SqlCommand = New SqlCommand(sqlsoal, cn)
                    ...
                    Else
                        SoalText.Text = "Data Tidak Ditemukan"
                        JawabA.Text = "Data Tidak Ditemukan"
                        JawabB.Text = "Data Tidak Ditemukan"
                        JawabC.Text = "Data Tidak Ditemukan"
                        JawabD.Text = "Data Tidak Ditemukan"
                    End If
                End If
            Catch ex As Exception
