<%@ Page Title="" Language="VB" MasterPageFile="~/User/MPUser.master" AutoEventWireup="false" CodeFile="LihatHasil.aspx.vb" Inherits="User_LihatHasil" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="container-fluid">
        <div class="row justify-content-center" style="margin-top:20px;"><h3>Hasil Tes</h3></div>
